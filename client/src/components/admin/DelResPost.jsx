...
const DelResPost = () => {
  ...
  return (
    ...
    <Grid container spacing={2} className='login-form'>
        ...
        <Grid item xs={12} >
            <Input name="postid" label="Postid" handleChange={handleChange} type="text" 
                required={true} value={formData.postid} helperText={`Enter the postid of the post you want to ${isDelete?'delete':'restrict'}`}/>
        </Grid>
        <Grid item xs={12}>
