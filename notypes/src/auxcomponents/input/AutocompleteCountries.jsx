...
const AutocompleteCountries = ({value,setValue}) => {
    ...
    return (
        ...
        <Grid item xs={12} >
        <Autocomplete
        value={countries.filter((country)=>country.label===value).length>0?countries.filter((country)=>country.label===value)[0]:null}
        onChange={(event, newValue) => {
          setValue(event,newValue.label===' '?null:newValue.label);
        }}
