...
export default function DraftTextArea({field,setField,placeholder,textMaxLength}) {
  ...
  const _handlePastedText = (pastedText) => {
    ...
    if (currentContentLength + pastedText.length - selectedTextLength > textMaxLength) {
      //console.log('you can type max ten characters');
  ...
  return (
      ...
      <div style={{color: 'rgba(0, 0, 0, 0.6)',
                  ...
                  marginBottom: '0',
                  marginLeft: '14px'}}>
         {editorState.getCurrentContent().getPlainText('').length}/{textMaxLength} characters</div>
     </div> 
  );
}
