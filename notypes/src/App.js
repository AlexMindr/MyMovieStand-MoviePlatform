...
import {Footer,Home,Movies,Errorpage,Moviepage,Login,Signup,Watchlistpage,
  ...
  Postaddpage,Postpage,Movieposts,Userposts,AdminUser,AdminMenu,AdminMovie,AdminForum, Resetpassword,Notifications} from './containers'
...
export default function App() {
  ...
  useEffect(() => {
    if(user && verifiedThisSession===true && fetchedThisSessionNotif===false){
