    ...
    <StyledEngineProvider injectFirst>
      <Paper elevation={2}>
        <Typography component="h2" variant="h3" className="Container-title">
          You are viewing all forum {value === 0 ? "posts" : "comments"} made by{" "}
            ...
            {postList !== null && postList.length >= 1 ? (
              <div className="userposts-pagination">
                <Pagination
                  ...
                  page={pagePost ? pagePost : 1}
                  variant="outlined"
                  shape="rounded"
                  showFirstButton
                  showLastButton
                  onChange={pageChangePost}
                />
              </div>
            ) : (
              <></>
            ...
            {postList !== null && postList.length >= 1 ? (
              <div className="userposts-pagination">
                <Pagination
                  ...
                  page={pageComm ? pageComm : 1}
                  variant="outlined"
                  shape="rounded"
                  showFirstButton
                  showLastButton
                  onChange={pageChangeComm}
                />
              </div>
            ) : (
              <></>
