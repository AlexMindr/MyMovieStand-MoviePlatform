...
const Navbar = () => {
  ...
  useEffect(() => {
    if (user) dispatch(actionGetNotif());
          ...
          {user && isLoggedIn ? (
            <>
              <div className="dropdown-submenu">
                <NavLink to={`/watchlist/${user.username}`}>
                  <IconButton className="watchlist-dropdown">
              ...
              <div className="dropdown-submenu">
                <IconButton onClick={refreshNotif}>
              ...
              <>
                <div className="dropdown-submenu">
                  ...
                  <div className="dropdown-content">
                    ...
                    <NavLink to={`/profile/${user.username}/reviews`}>
                      My Reviews
                    </NavLink>
                    <NavLink to={`/profile/${user.username}/posts`}>
                      My Posts
                    </NavLink>
            ...
            <>
              <NavLink
                state={{ from: location }}
                className={({ isActive }) =>
                  isActive ? `login-button ${activeStyle} ` : "login-button"
                }
                to="/login"
              >
                Login
