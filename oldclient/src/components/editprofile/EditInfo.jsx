...
const EditInfo = ({ initialState, currentName, username }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.firstName === "" || formData.lasttName === "") {
      setFormError(
        "You need to fill both first and last name fields if you want to change your name!"
      );
    } else {
      setFormError(false);
    ...
    return (
      ...
      >
        <Grid
          container
          spacing={2}
          className="editprofile-form-grid"
          sx={width > 800 ? { width: 500 } : { width: 300 }}
        >
          {formError ? (
            <Grid item xs={12}>
          ...
          <Input
            ...
            required={false}
            helperText={
              "If you want to change your name, both last and first name fields must be filled"
            }
          />
          <Input
            name="lastName"
          ...
          <Input
            ...
            helperText={
              "The new password must be at least 4 characters long and contain an uppercase letter and a number"
            }
          />
          ...
          <Grid item xs={12}>
            <Divider flexItem />
            <Typography variant="h6">
              In order to apply the changes you must provide your current
              password
            </Typography>
          </Grid>
          <Input
